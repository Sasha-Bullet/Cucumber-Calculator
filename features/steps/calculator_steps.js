...
var CalculatorSteps = function() {
  ...
  this.Then('the result of first row in history should equal $result', function (result, callback) {
    expect(this.page.getfirstHistoryResult()).to.eventually.equal(result).and.notify(callback);
  });
};
